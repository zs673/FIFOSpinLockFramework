...
public class NewMrsPRTAWithMCNP {
	...
	public long[][] NewMrsPRTATest(ArrayList<ArrayList<SporadicTask>> tasks, ArrayList<Resource> resources, long mig,
	...
	public long migrationCostBusyWindow(ArrayList<Integer> migration_targets_with_P, long oneMig, long np,
	...
	public long migrationCostOneCal(ArrayList<Integer> migration_targets_with_P, long oneMig, long duration,
			Resource resource, ArrayList<ArrayList<SporadicTask>> tasks) {
		long migCost = 0;
