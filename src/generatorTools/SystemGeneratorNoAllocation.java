...
public class SystemGeneratorNoAllocation {
	...
	public SystemGeneratorNoAllocation(int minT, int maxT, double util, int total_partitions, int number_of_tasks_per_processor, boolean isLogUni,
