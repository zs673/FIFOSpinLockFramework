...
public class SystemGeneratorNoAllicationDM {
	...
	public SystemGeneratorNoAllicationDM(int minT, int maxT, double util, int total_partitions, int number_of_tasks_per_processor,
