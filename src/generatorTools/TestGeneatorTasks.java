...
public class TestGeneatorTasks {
	...
	public static void main(String[] args) {
		...
		for (int j = 0; j < NUMBER_OF_SYSTEMS; j++) {
			...
			ArrayList<ArrayList<SporadicTask>> tasksRRF = geneator.allocateTasks(tasks, resources, TOTAL_PARTITIONS, ALLOCATION_POLICY.RESOURCE_REQUEST_TASKS_FIT);
			geneator.testifyAllocatedTasksetAndResource(tasksRRF, resources);
			
			System.out.println("\n\n");
			System.out.println(" RESOURCE LOCAL FIT");
			ArrayList<ArrayList<SporadicTask>> tasksRLF = geneator.allocateTasks(tasks, resources, TOTAL_PARTITIONS, ALLOCATION_POLICY.RESOURCE_LOCAL_FIT);
