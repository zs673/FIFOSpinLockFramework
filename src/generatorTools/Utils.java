...
public class Utils {
	...
	private static double PFP_SCHEDULER = (double) (492 + 603 + 274 + 308) / (double) 1000;
	private static double LITMUS_RELEASE = (double) (1383) / (double) 1000;
	private static double LITMUS_COMPLETE = (double) (411) / (double) 1000;

	private static double PFP_SCHED_CHECK = (double) (492) / (double) 1000;
