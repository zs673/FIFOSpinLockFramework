...
public class FIFOSpinLockFramework {
	...
	/**
	 * Calculate the response time of all tasks using each protocol. Obtain the blocking time of each resource with each protocol. 
	 * @param tasks
	 * @param resources
	 */
...
//			int fifomp_perference = 0, fifop_perference = 0, mrsp_perference = 0;
//			for(int i=0;i<tasks.size();i++){
//				
//			}
		}
