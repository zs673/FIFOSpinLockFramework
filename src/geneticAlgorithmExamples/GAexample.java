...
public class GAexample {
	...
	public static void main(String[] args) throws IOException {
		GAexample ga = new GAexample(500, 50, 100000, 0.8f, 0.9f);
		System.out.println("Start....  value size: " + ga.v.length + "    b sive: " + ga.b.length);
		ga.init();
		ga.solve();
	}

	private int[] v = { 220, 208, 198, 192, 180, 180, 165, 162, 160, 158, 155, 130, 125, 122, 120, 118, 115, 110, 105,
			101, 100, 100, 98, 96, 95, 90, 88, 82, 80, 77, 75, 73, 72, 70, 69, 66, 65, 63, 60, 58, 56, 50, 30, 20, 15,
			10, 8, 5, 3, 1 };// 物品价值
	private int[] b = { 80, 82, 85, 70, 72, 70, 66, 50, 55, 25, 50, 55, 40, 48, 50, 32, 22, 60, 30, 32, 40, 38, 35, 32,
			25, 28, 30, 22, 50, 30, 45, 30, 60, 50, 20, 65, 20, 25, 30, 10, 20, 25, 15, 10, 10, 10, 4, 4, 2, 1 };// 物品体积
